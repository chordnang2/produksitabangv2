            ...
            <div class="page-body">
                <div class="container-xl">
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                <form action="<?php echo base_url() ?>ccr/loadAjaxHandson" method="GET">
                                            ...
                                            <div class="form-selectgroup">
                                                <label class="form-selectgroup-item">
                                                    <select class="form-select" id="tahun" name="tahun">
                                                        <option>Pilih</option>
                                                        <?php foreach ($tahunAll as $key => $value) { ?>
                                ...
                                <div class="card-body">
                                    <?php if (isset($tahun)) { ?>
                                        <h3 class="card-title">Form Excel CCR <b><i>Forecast</i></b> Tahun <b><i><?= $tahun ?></i></b></h3>
                                        <div class="col-lg-12">
                                            <div id="ht" class="hot mb-4"></div>
                                            <div class="controls">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            const hot = new Handsontable(container, {
                                                ...
                                                colHeaders: ['Bulan', 'Tahun', 'Jumlah Hari Kerja', 'Jumlah Hari Off', 'Jumlah Hari Suspend', 'Target Kontrak', 'Lokasi'],
                                                height: '150px',
                                            ...
                                            Handsontable.dom.addEvent(save, 'click', () => {
                                                ...
                                                ajax('<?php echo base_url() ?>Ccr/ajaxHandson', 'POST', JSON.stringify({
                                                    data: hot.getData()
                                                }), res => {
