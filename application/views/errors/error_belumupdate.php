		...
		<div class="page">
			...
			<div class="page-content">
				<div class="container text-center text-dark">
					<div class="display-1  text-dark mb-5">0</div>
					<p class="h5 font-weight-normal mb-7 leading-normal">Data belum diupdate,<br> Silahkan update data dahulu.</p>
					<a class="btn btn-primary  mb-5" href="<?=base_url();?>daily_produksi">
						Kembali
					</a>
				</div>
			</div>
