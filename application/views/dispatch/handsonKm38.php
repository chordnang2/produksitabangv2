            ...
            <div class="page-body">
                <div class="container-xl">
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                <form action="<?php echo base_url() ?>dispatch/loadAjaxHandsonKm38" method="GET">
                                    <div class="card-header">
                                        <div class="mb-0">
                                            <label class="form-label">Pilih Tanggal</label>
                                            <div class="form-selectgroup">
                                                <label class="form-selectgroup-item">
                                                    <input class="form-control mb-2" placeholder="Select a date" id="datepicker-default" name="date" autocomplete="off" value="<?= $date ?>" width="2"/>
                                                </label>
                                                <label class="form-selectgroup-item">
                                ...
                                <div class="card-body">
                                    <?php if ($date) { ?>
                                        <h3 class="card-title">Form Excel Dispatch <b><i>KM 38</i></b> Tanggal <b><i><?= date_format(date_create($date), "d M Y"); ?></i></b></h3>
                                        <div class="col-lg-12">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            Handsontable.dom.addEvent(save, 'click', () => {
                                                ...
                                                ajax('<?php echo base_url() ?>dispatch/ajaxHandsonKm38', 'POST', JSON.stringify({
                                                    data: hot.getData()
                                                }), res => {
