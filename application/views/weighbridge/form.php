            ...
            <div class="page-body">
                <div class="container-xl">
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                <form action="<?php echo base_url() ?>weighbridge/formAjaxHandson" method="GET">
                                    <div class="card-header">
                                        <div class="mb-0">
                                            <label class="form-label">Pilih Tanggal</label>
                                            <div class="form-selectgroup">
                                                <label class="form-selectgroup-item">
                                                    <input class="form-control mb-2" placeholder="Select a date" id="datepicker-default" value="<?php if ($date) {
                                                                                                                                                    echo $date;
                                ...
                                <div class="card-body">
                                    <?php if ($date) { ?>
                                        <h3 class="card-title">Form Excel Data Produksi <b><i>Timbangan</i></b> Tanggal <b><i><?= date_format(date_create($date), "d M Y"); ?></i></b></h3>
                                        <div class="col-lg-12">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            Handsontable.dom.addEvent(save, 'click', () => {
                                                ...
                                                ajax('<?php echo base_url() ?>weighbridge/ajaxHandson', 'POST', JSON.stringify({
                                                    data: hot.getData()
                                                }), res => {
